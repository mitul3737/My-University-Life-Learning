...
class Teacher:
    def greet(self):
        Person.greet(self) #accessing Person's greet method
...
class TeachingAssistant(Student,Teacher):
    ...
    def greet(self):
        Student.greet(self)  # accessing Student's greet method
        Teacher.greet(self)  # accessing Teacher's greet method
